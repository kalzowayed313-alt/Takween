...
import { X, Mail, Calendar, Target, Clock, CheckCircle2, AlertCircle, BrainCircuit, Sparkles, TrendingUp, ShieldAlert, Archive, UserCog, Save, History, Lock, Building2, ChevronLeft, Flag } from 'lucide-react';
  ...
  return (
    <>
                  ...
                  <div className="bg-slate-50 dark:bg-slate-800 p-6 rounded-3xl border border-slate-100 dark:border-slate-700">
                    ...
                    <div className="space-y-3">
                      ...
                      {isAdmin && (
                        ...
                        >
                          <Archive size={16} /> تعطيل الحساب / أرشفة
                        </button>
                      )}
                    </div>
                  </div>
      ...
      <ConfirmationModal 
        ...
        title="هل أنت متأكد من تعطيل حساب الموظف؟"
        message={`سيتم نقل حساب المهندس ${employee.name} إلى الأرشيف وسيتم سحب كافة صلاحيات الدخول منه. يمكنك إعادة تنشيط الحساب لاحقاً من قسم الطلبات المعلقة.`}
